...
public class texgen extends GLCanvas {
	...
	myGL.glTexImage1D(GL.GL_TEXTURE_1D, 0, 4, stripeImageWidth, 0,
                 GL.GL_RGBA, GL.GL_UNSIGNED_BYTE, stripeImage);
...
//	myUT.glutSolidSphere(2.0, 20, 20);
//	myUT.glutSolidTorus(0.5, 1.0, 20, 20);
