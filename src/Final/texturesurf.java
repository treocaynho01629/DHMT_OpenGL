...
public class texturesurf extends GLCanvas {
    ...
    private static final float ctrlpoints2 [][][] = {
			{{-1.5f, 0.5f,  0.0f},
		 {-1.0f, 0.75f,  0.0f},
		 { 0.0f, 1.25f, 0.0f},
		 { 0.5f, 0.5f,  0.0f}},
	...
	myGL.glEvalMesh2 (GL.GL_LINE, 0, 20, 0, 20);
	myGL.glFlush ();
    }
	...
	if (w <= h) {
        ...
        myGL.glLoadIdentity ();
	myGL.glRotatef (15.0f, 1.0f, 1.0f, 1.0f);
    }
