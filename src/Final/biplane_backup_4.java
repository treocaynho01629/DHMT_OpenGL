...
public class biplane_backup_4 extends GLCanvas {
    ...
    private static int milliseconds_per_frame = 100; //animation timer
...
//		break;
    ...
    static public void main (String args[]) throws IOException {
		...
		biplane_backup_4 mainCanvas = new biplane_backup_4 ();
		mainCanvas.init();
